...
- Target Group.
- Load Balancer Listener that routes traffic to the Target Group.
- EC2 instance Launch Template.
### Location
`modules/alb_autoscaling/main.tf`
...
Variable | Type | Explaination
--- | --- | --- 
vpc_id | string | VPC to assign the ASG to
public_subnets | list[string] | public subnets to attach to the ASG
instance_type | string | EC2 instance's type for the Launch Template
min_instances | int | minimum count of instances for the ASG
max_instances | int | maximum count of instances for the ASG
assign_public_ip | boolean | Wether or not to assign a public IP for the EC2 instance in the Launch Template

### Output
You can see the public DNS name of the created Application Load Balancer by using:
